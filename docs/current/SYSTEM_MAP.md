...
Provider normalizers, rights owner, media-selection owner и persisted schema не менялись. Текущий checkpoint — **PLAN-9D**. Mini plan reconciliation 2026-08-11 отменила прежнюю формулировку «следующий шаг — LIVE-5»: закрыты WP0-A machine gates (`98e58fe`, `a9bfc11`) и VA-NEW-01 (`15cb20d`) — continuity стала advisory-отчётом на canonical evidence и больше не производит `missing_scenes`; ранее закрыт VA-NEW-03 (`37ca498`). До LIVE-5 аудит `docs/audits/VISUAL_ASSET_INTEGRITY_AUDIT_2026-08-10.md` требует ещё VA-NEW-02, 04, 05, 06, 08, 09 и минимальные budget guards 10/12 внутри существующих owners PLAN-9A, PLAN-9E, PLAN-10B и PLAN-10C; новых owner-границ и новых PLAN-ID это не создаёт. Полная сводка маршрута — блок «Mini plan reconciliation 2026-08-11» в [PROJECT_EXECUTION_PLAN.md](PROJECT_EXECUTION_PLAN.md).
