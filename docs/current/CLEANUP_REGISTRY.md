...
неточным и заменено строками `C84`–`C86` ниже: `maximum_calls_per_project` —
детерминированный hard cap на число платных запросов **проекта**,
