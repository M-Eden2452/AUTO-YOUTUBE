...
Итог: карантин `2026-08-13` — **131 файл** вместо 156 (`broll` 35 файлов и
`images/generated` 26 не тронуты, `cache/videos` 95 → 70), общий карантин с
новой папкой — 155 файлов, 6.9 GB. Ничего не удалено, счётчики сверены после
...
7 файлов карантина без записанного источника **не возвращены** и остаются в нём
