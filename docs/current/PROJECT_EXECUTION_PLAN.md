...
- **две правки прибора по итогам двух внешних ревью, тот же день (§12 отчёта).**
  Оба ревью дали «готово» и оба пропустили по дефекту, а одно сослалось на прогон
  тестов, которого не было (заявлено 16 тестов и 1.5 с; та же команда даёт 82
  теста и 135 с, один класс baseline — 127 с). Исправлено: (1) сцена больше не
  ...
  раздельно, плюс `cards not shown to anyone`. Доска пересобрана; годна только
  новая. На v1 оба чтения совпадают, число прежнее 4/14.
