...
- **rollback:** implementation commit плюс два bounded repair commit; revert в
  ...
  действий нет.
- **next:** independent read-only review именно **второго** repair commit.
