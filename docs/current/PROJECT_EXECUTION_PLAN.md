...
- **status:** in progress · owner-issued 2026-08-10 (plan reconciliation после
  ...
  выполнен 2026-08-10 — **этот implementation commit**; второй bounded
  sub-slice (retrieval symmetry) — pending, отдельный owner prompt.
- **выполнено первым sub-slice.** Канонический decision owner —
...
- **required verification:** красные-сначала characterization tests на пять
  acceptance cases; owning radius selection/manifest; полный offline suite
  (меняется production selection contract).
- **rollback:** один policy-commit (+ один retrieval-symmetry commit), revert в
  обратном порядке; migраций данных нет.
