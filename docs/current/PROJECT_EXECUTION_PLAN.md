...
- **rollback:** implementation commit плюс один bounded repair commit; revert в
  ...
  действий нет.
- **next:** independent read-only review именно этого repair commit, затем
  свежий diagnostic русский Short. Только после успешного product
  diagnostic владелец решает, возвращаться ли к **PLAN-9D-D**.
...
- **status:** next (PLAN-9D-C closed 2026-08-09) · **commit:** —
