...
- **rollback:** один bounded implementation commit; revert этого commit.
  Миграций данных, новых artifact/layout и необратимых действий нет.
- **next:** independent read-only review именно этого implementation commit,
  затем свежий diagnostic русский Short. Только после успешного product
